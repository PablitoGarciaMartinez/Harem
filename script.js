...
// Scroll to store on title click
const enterStoreBtn = document.getElementById('enter-store-btn');
if (enterStoreBtn) {
  enterStoreBtn.addEventListener('click', () => {
    document.body.style.overflowY = 'auto'; // Habilitar el scroll al entrar

    // Un pequeño retraso para permitir al navegador aplicar el overflow
    setTimeout(() => {
